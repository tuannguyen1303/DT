...
namespace DigitalTwin.Models.Requests.Entity
{
    public class GetAllEntitiesRequest : BaseRequest, IRequest<Response<GetEntitiesFilterAdvancedResponse>>, IFrequency
    {
        public Guid ValueChainType { get; set; }
